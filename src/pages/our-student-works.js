...
const OurStudentWorks = () => {
  ...
  return (
    <div className="body-wrap overflow-hidden">
      <Helmet>
        <title>Student Showcase | Creativa Design Academy Projects</title>
        <meta
          name="description"
          content="Explore exceptional projects by Creativa Design Academy students. Witness their creative journey through intuitive app interfaces and captivating web designs."
        />
        <meta
          name="keywords"
        ...
        <meta
          name="title"
          content="Student Showcase | Creativa Design Academy Projects"
        />
      </Helmet>
      ...
      <section className="section">
        <div className="position-relative">
          ...
          <OurStudentWorksSection
            headingDetails={ourStudentWorkHeadingDetails}
          />
        </div>
      </section>
