...
const UiUxCourse = ({ bookMySeat }) => {
  return (
    <Container>
      ...
      <h1 className="courses-title mb-md-4 mb-3">
        UI/UX Design Course Updates
      </h1>
      <p className="course-syllabus-desc pb-md-5 pb-3">
        Discover the latest updates for our classes—combining the best of
        offline and online learning experiences.
      </p>

      <Row>
        <Col md={6}>
          <div className="course-card">
            <div className="course-badge">Online Live</div>
            <h2 className="course-card-title mt-md-5 mt-3">
              UX UI Design Course Program
            </h2>
            <Row>
              <Col md={6}>
            ...
            <Button
              variant="primary"
              className="btn-block-green mt-5"
              onClick={bookMySeat}
            >
              Enroll Now
            </Button>
        ...
        <Col md={6}>
          <div className="course-card">
            <div className="course-badge">Offline Classroom</div>
            <h2 className="course-card-title mt-md-5 mt-3">
              UX UI Design Course Program
            </h2>
            <Row>
